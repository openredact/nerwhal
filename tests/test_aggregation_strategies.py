...
def test_aggregation():
    piis_a = [Pii(start=64, end=71, type="MISC", text="han.solo", score=0.92, model="flair_ner_multi_fast")]
    piis_b = [Pii(start=64, end=85, type="EMAIL", text="han.solo@imperium.com", score=1.0, model="re")]
    piis_c = [Pii(start=64, end=85, type="ORG", text="han.solo@imperium.com", score=0.83, model="spacy_de_core_news_sm")]
