...
class DePhoneNumberRecognizer(EntityRulerRecognizer):
    ...
    def patterns(self):
        return [
            ...
            [  # Microsoft's canonical format, e.g. +49 (030) 12345
                {"TEXT": {"REGEX": self.COUNTRY_CODES_REGEX}},
                {"TEXT": "(", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_AREA_CODE}},
                {"TEXT": ")", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_SUBSCRIBER_NUMBER}},
                {"TEXT": "-", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_EXTENSION}, "OP": "?"},
            ],
            [  # Microsoft's canonical format, e.g. +49 (0) 30 12345
                ...
                {"TEXT": "0"},
                {"TEXT": ")", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_AREA_CODE - 1}},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_SUBSCRIBER_NUMBER}},
                {"TEXT": "-", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_EXTENSION}, "OP": "?"},
            ],
            [  # E.123 style with blocks
                ...
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_AREA_CODE}},
                {"IS_SPACE": True, "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_BLOCK}, "OP": "?"},
                {"IS_SPACE": True, "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_BLOCK}, "OP": "?"},
                {"IS_SPACE": True, "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": max(self.MAX_LEN_BLOCK, self.MAX_LEN_EXTENSION)}, "OP": "?"},
                {"TEXT": "/", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_EXTENSION}, "OP": "?"},
            ],
            [  # Abbreviated, e.g. tel:+49-30-1234567
                {"TEXT": {"REGEX": self.COUNTRY_CODES_REGEX.replace("^", r"^\w+\.?:")}},
                {"TEXT": {"IN": [" ", "-"]}},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_AREA_CODE}},
                {"TEXT": {"IN": [" ", "-"]}},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_SUBSCRIBER_NUMBER}},
            ...
            [{"TEXT": {"REGEX": self.COUNTRY_CODES_REGEX.replace("$", r"(\.\d{2,14})+$")}}],  # Dotted format, e.g. +49.3012345
            # >>> National numbers
            ...
            [  # E.123, e.g. (030) 12345 0 / 67
                ...
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_SUBSCRIBER_NUMBER}},
                {"IS_SPACE": True, "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_BLOCK}, "OP": "?"},  # supports max 3 blocks incl. extension
                {"IS_SPACE": True, "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_EXTENSION}, "OP": "?"},
                {"TEXT": "/", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_EXTENSION}, "OP": "?"},  # supports one alternative extension
            ],
            [  # Non-standard format, e.g. 0 30 / 12 34 56
                {"TEXT": "0", "OP": "?"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_AREA_CODE}},
                {"TEXT": "/"},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_BLOCK}},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_BLOCK}},
                {"IS_DIGIT": True, "LENGTH": {"<=": self.MAX_LEN_BLOCK}},
            ],
        ]
